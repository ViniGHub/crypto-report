...
import carreiras.com.github.listadecompras.model.ReportsModel
 ...
 * @since 2023-03-01
 */
class ReportsAdapter(private val onItemRemoved: (ReportsModel) -> Unit) :
    RecyclerView.Adapter<ReportsAdapter.ItemViewHolder>() {

    // Lista de itens que serão exibidos no RecyclerView.
    private var items = listOf<ReportsModel>()
    ...
    inner class ItemViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val textView = view.findViewById<TextView>(R.id.value_report)
        val dateView = view.findViewById<TextView>(R.id.value_date)
     ...
     */
    fun updateItems(newItems: List<ReportsModel>) {
